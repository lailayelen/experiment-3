...
$(function() {
  ...
  function set_settings() {
    ...
    settings.likes_by = ['Moshe','Dan','Sarah','Tal','Yana','Asyl','Gal','Tomer','Yaron']; 
  }
  ...
  function init_text() {
  	...
  	$('#submit_text').on('click',function() {
  		...
  		if($('#description').val() !== "" && $('#description').val().length < 120) {
